    ...
    <footer sx={styles.footer}>
      <Container>
        ...
        <Box sx={styles.footer.footerBottomArea}>
          ...
          <a style={{display:'flex', alignItems:'center',justifyContent:'center',textDecoration:'none'}} href='https://farhanibnesaif.vercel.app' target='_blank'>
            <Image style={{height:'30px',width:'30px'}} src={FooterLogo} alt="Logo" />
            <h3 style={{marginLeft:'10px',marginRight:'10px'}}> CRYPTOSTICKIES</h3> {new Date().getFullYear()} 
          </a>
